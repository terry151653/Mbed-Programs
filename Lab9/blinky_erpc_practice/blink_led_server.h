...
private:
    /*! @brief Server shim for led3_change of LEDBlinkService interface. */
    erpc_status_t led3_change_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
};
